  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: 'Infection control is a vital component of nursing practice and a frequent topic on the NCLEX. Understanding the four types of isolation precautions and how to apply them will help you answer related questions correctly.',
  ...
  return (
    <>
      <SeoHead
        ...
        canonicalUrl={`https://nurseassistinternational.com/blogs/news/nclex-mastery-breaking-down-infection-control-isolation-precautions`}
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-nai-soft via-white to-teal-50">
          ...
          <div className="container-full-width">
            ...
            >
              ...
              <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                ...
                <span>/</span>
                <span className="text-gray-900">Infection Control Mastery</span>
              </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
              ...
              <div className="order-2 lg:order-1">
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 border border-gray-100">
                  <h2 className="text-xl sm:text-2xl font-bold text-nai-teal mb-3 sm:mb-4 break-words">Infection Control Mastery</h2>
                  ...
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <span className="text-xs sm:text-sm text-gray-600 break-words">Standard precautions for all patients</span>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-xs sm:text-sm text-gray-600 break-words">Contact precautions for direct transmission</span>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-xs sm:text-sm text-gray-600 break-words">Droplet precautions for respiratory infections</span>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-xs sm:text-sm text-gray-600 break-words">Airborne precautions for TB and measles</span>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 shadow-xl border border-gray-100">
                    <div className="grid grid-cols-3 gap-3 sm:gap-4 text-center">
                      <div>
                        <div className="text-base sm:text-lg md:text-xl font-bold text-nai-teal mb-1">4 Types</div>
                        <div className="text-xs sm:text-sm text-gray-600">Precautions</div>
                      </div>
                      <div>
                        <div className="text-base sm:text-lg md:text-xl font-bold text-nai-teal mb-1">Safety</div>
                ...
                >
                  ...
                  <div className="bg-white border-2 border-blue-200 rounded-xl p-4 sm:p-6 mb-8 sm:mb-12 shadow-md">
                    <h3 className="text-lg sm:text-xl font-bold text-nai-teal mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3">
                      ...
                      <span className="break-words">Infection Control Guide</span>
                    </h3>
                    <nav className="space-y-2">
                      <a href="#standard-precautions" className="block text-nai-teal/600 hover:text-nai-teal/800 transition-colors py-1 text-sm font-medium text-gray-800">
                        1. Standard Precautions
                      </a>
                      <a href="#contact-precautions" className="block text-nai-teal/600 hover:text-nai-teal/800 transition-colors py-1 text-sm font-medium text-gray-800">
                        2. Contact Precautions
                      </a>
                      <a href="#droplet-precautions" className="block text-nai-teal/600 hover:text-nai-teal/800 transition-colors py-1 text-sm font-medium text-gray-800">
                        3. Droplet Precautions
                      </a>
                      <a href="#airborne-precautions" className="block text-nai-teal/600 hover:text-nai-teal/800 transition-colors py-1 text-sm font-medium text-gray-800">
                        4. Airborne Precautions
                      </a>
                      <a href="#ppe-procedures" className="block text-nai-teal/600 hover:text-nai-teal/800 transition-colors py-1 text-sm font-medium text-gray-800">
                  ...
                  <div className="prose prose-lg max-w-none prose-headings:text-nai-teal/900 prose-p:text-gray-700 prose-a:text-nai-teal/600 prose-strong:text-nai-teal/600">
                    ...
                    <div className="bg-gradient-to-r from-nai-teal/50 to-nai-deep-teal50 border-l-4 border-nai-teal/500 rounded-r-xl p-8 mb-12">
                      ...
                      <div className="bg-white rounded-lg p-6 border border-nai-teal/200 shadow-sm">
                        <div className="grid md:grid-cols-2 gap-6">
                          <div>
                            <h4 className="font-bold text-nai-teal/800 mb-3">NCLEX Focus Areas:</h4>
                            <ul className="text-sm text-gray-700 space-y-1">
                              <li>• Types of isolation precautions</li>
                              <li>• Appropriate PPE selection</li>
                              <li>• Hand hygiene protocols</li>
                            </ul>
                          </div>
                          <div>
                            <h4 className="font-bold text-nai-teal/800 mb-3">Patient Safety Goals:</h4>
                            <ul className="text-sm text-gray-700 space-y-1">
                              <li>• Prevent healthcare-associated infections</li>
                              <li>• Protect patients and healthcare workers</li>
                              <li>• Break the chain of infection transmission</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    <h2 id="standard-precautions" className="text-3xl font-bold text-nai-teal/900 mb-8 flex items-center gap-3">
                    ...
                    <div className="bg-white border-2 border-nai-teal/20 rounded-2xl p-8 mb-12 shadow-lg">
                      <p className="text-lg leading-relaxed text-gray-700 mb-6">
                        <strong className="text-nai-teal/600">Used for all patients</strong>, these include hand hygiene and appropriate use of personal protective equipment (PPE) to prevent the spread of infection.
                      </p>
                      
                      <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-nai-teal/50 rounded-xl p-6 border border-nai-teal/200">
                          <h4 className="text-xl font-bold text-nai-teal/800 mb-4">Key Components</h4>
                          <ul className="space-y-3 text-gray-700">
                            <li className="flex items-start gap-3">
                              <div className="w-3 h-3 bg-nai-teal/500 rounded-full mt-2"></div>
                              <div>
                                <h5 className="font-semibold text-gray-900">Hand Hygiene</h5>
                                <p className="text-sm text-gray-600">Before and after patient contact</p>
                              </div>
                            </li>
                            <li className="flex items-start gap-3">
                              <div className="w-3 h-3 bg-nai-teal/500 rounded-full mt-2"></div>
                              <div>
                                <h5 className="font-semibold text-gray-900">PPE Use</h5>
                                <p className="text-sm text-gray-600">Gloves, gowns, masks as needed</p>
                              </div>
                            </li>
                            <li className="flex items-start gap-3">
                              <div className="w-3 h-3 bg-nai-teal/500 rounded-full mt-2"></div>
                              <div>
                                <h5 className="font-semibold text-gray-900">Safe Injection Practices</h5>
                                <p className="text-sm text-gray-600">One needle, one syringe, one use</p>
                              </div>
                            </li>
                          </ul>
                        </div>
                        
                        <div className="bg-nai-deep-teal50 rounded-xl p-6 border border-nai-deep-teal200">
                          <h4 className="text-xl font-bold text-nai-deep-teal800 mb-4">When to Apply</h4>
                          <ul className="space-y-3 text-gray-700">
                            <li className="flex items-center gap-3">
                              <CheckCircle className="w-5 h-5 text-nai-deep-teal600" />
                              <span>All patient interactions</span>
                            </li>
                            <li className="flex items-center gap-3">
                              <CheckCircle className="w-5 h-5 text-nai-deep-teal600" />
                              <span>Contact with blood or body fluids</span>
                            </li>
                            <li className="flex items-center gap-3">
                              <CheckCircle className="w-5 h-5 text-nai-deep-teal600" />
                              <span>Handling contaminated equipment</span>
                            </li>
                            <li className="flex items-center gap-3">
                              <CheckCircle className="w-5 h-5 text-nai-deep-teal600" />
                              <span>Environmental cleaning tasks</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    {/* Section 2: Contact Precautions */}
                    <h2 id="contact-precautions" className="text-3xl font-bold text-nai-teal/900 mb-8 flex items-center gap-3">
                      <span className="bg-orange-500 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold">2</span>
                      Contact Precautions
                    </h2>
                    <div className="bg-white border-2 border-orange-100 rounded-2xl p-8 mb-12 shadow-lg">
                      <p className="text-lg leading-relaxed text-gray-700 mb-6">
                        Required for infections spread by <strong className="text-orange-600">direct contact</strong> (e.g., MRSA, C. difficile). Wear gloves and gowns; dedicate equipment to the patient to avoid cross-contamination.
                      </p>
                      
                      <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-8 border border-orange-200">
                        <h4 className="text-2xl font-bold text-orange-800 mb-6">Contact Precaution Protocol</h4>
                        <div className="grid md:grid-cols-2 gap-8">
                          <div>
                            <h5 className="font-bold text-orange-700 mb-4">Common Organisms:</h5>
                          ...
                          <div>
                            <h5 className="font-bold text-orange-700 mb-4">Required PPE:</h5>
                            <ul className="space-y-2 text-gray-700">
                              <li className="flex items-center gap-2">
                                <CheckCircle className="w-4 h-4 text-orange-600" />
                                <span>Gloves before entering room</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <CheckCircle className="w-4 h-4 text-orange-600" />
                                <span>Gown for direct patient contact</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <CheckCircle className="w-4 h-4 text-orange-600" />
                                <span>Dedicated patient equipment</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <CheckCircle className="w-4 h-4 text-orange-600" />
                                <span>Remove PPE before leaving room</span>
                              </li>
                            </ul>
                          </div>
                        </div>
                    ...
                    {/* Section 3: Droplet Precautions */}
                    <h2 id="droplet-precautions" className="text-3xl font-bold text-nai-teal/900 mb-8 flex items-center gap-3">
                    ...
                    <div className="bg-white border-2 border-blue-100 rounded-2xl p-8 mb-12 shadow-lg">
                      <p className="text-lg leading-relaxed text-gray-700 mb-6">
                        Used for <strong className="text-blue-600">respiratory infections like influenza</strong>. Wear a surgical mask within one metre of the patient; the patient should wear a mask when transported.
                      </p>
                      
                      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-8 border border-blue-200">
                        <h4 className="text-2xl font-bold text-blue-800 mb-6">Droplet Transmission Control</h4>
                        <div className="grid md:grid-cols-3 gap-6">
                          <div className="bg-white rounded-lg p-6 shadow-sm border border-blue-100">
                            <Zap className="w-8 h-8 text-blue-600 mb-3" />
                            <h5 className="font-bold text-blue-700 mb-2">Common Infections</h5>
                            <ul className="text-sm text-gray-700 space-y-1">
                              <li>• Influenza</li>
                              <li>• Pertussis (whooping cough)</li>
                              <li>• Pneumonia (certain types)</li>
                              <li>• Meningitis (bacterial)</li>
                            </ul>
                          </div>
                          <div className="bg-white rounded-lg p-6 shadow-sm border border-blue-100">
                            <Shield className="w-8 h-8 text-blue-600 mb-3" />
                            <h5 className="font-bold text-blue-700 mb-2">PPE Requirements</h5>
                            <ul className="text-sm text-gray-700 space-y-1">
                              <li>• Surgical mask within 1 meter</li>
                              <li>• Standard precautions apply</li>
                              <li>• Patient mask during transport</li>
                              <li>• Private room preferred</li>
                            </ul>
                          </div>
                          <div className="bg-white rounded-lg p-6 shadow-sm border border-blue-100">
                            <Users className="w-8 h-8 text-blue-600 mb-3" />
                            <h5 className="font-bold text-blue-700 mb-2">Transmission Range</h5>
                            <ul className="text-sm text-gray-700 space-y-1">
                              <li>• Large droplets (&gt;5 micrometers)</li>
                              <li>• Travel up to 1 meter</li>
                              <li>• Generated by coughing/sneezing</li>
                              <li>• Don't remain airborne long</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    {/* Section 4: Airborne Precautions */}
                    <h2 id="airborne-precautions" className="text-3xl font-bold text-nai-teal/900 mb-8 flex items-center gap-3">
                      <span className="bg-red-500 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold">4</span>
                      Airborne Precautions
                    </h2>
                    <div className="bg-white border-2 border-red-100 rounded-2xl p-8 mb-12 shadow-lg">
                      <p className="text-lg leading-relaxed text-gray-700 mb-6">
                        Used for infections like <strong className="text-red-600">tuberculosis and measles</strong>. Place the patient in a negative-pressure room and wear an N95 respirator. Limit transport.
                      </p>
                      
                      <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-8 border border-red-200">
                        <h4 className="text-2xl font-bold text-red-800 mb-6">Maximum Protection Protocol</h4>
                        <div className="grid md:grid-cols-2 gap-8">
                          <div>
                            <h5 className="font-bold text-red-700 mb-4">High-Risk Infections:</h5>
                            <ul className="space-y-3 text-gray-700">
                              <li className="flex items-start gap-3">
                                <AlertCircle className="w-5 h-5 text-red-600 mt-0.5" />
                                <div>
                                  <h6 className="font-semibold">Tuberculosis (TB)</h6>
                                  <p className="text-sm text-gray-600">Requires N95 respirator</p>
                                </div>
                              </li>
                              <li className="flex items-start gap-3">
                                <AlertCircle className="w-5 h-5 text-red-600 mt-0.5" />
                                <div>
                                  <h6 className="font-semibold">Measles (Rubeola)</h6>
                                  <p className="text-sm text-gray-600">Highly contagious airborne virus</p>
                                </div>
                              </li>
                              <li className="flex items-start gap-3">
                                <AlertCircle className="w-5 h-5 text-red-600 mt-0.5" />
                                <div>
                                  <h6 className="font-semibold">Varicella (Chickenpox)</h6>
                                  <p className="text-sm text-gray-600">Contact + airborne precautions</p>
                                </div>
                              </li>
                            </ul>
                          </div>
                          <div>
                            <h5 className="font-bold text-red-700 mb-4">Critical Requirements:</h5>
                            <ul className="space-y-3 text-gray-700">
                              <li className="flex items-center gap-3">
                                <CheckCircle className="w-5 h-5 text-red-600" />
                                <span>Negative-pressure room (AIIR)</span>
                              </li>
                              <li className="flex items-center gap-3">
                                <CheckCircle className="w-5 h-5 text-red-600" />
                                <span>N95 respirator (fit-tested)</span>
                              </li>
                              <li className="flex items-center gap-3">
                                <CheckCircle className="w-5 h-5 text-red-600" />
                                <span>Door kept closed at all times</span>
                              </li>
                              <li className="flex items-center gap-3">
                                <CheckCircle className="w-5 h-5 text-red-600" />
                                <span>Limit and minimize transport</span>
                              </li>
                            </ul>
                          </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-nai-teal/100 via-nai-deep-teal50 to-nai-teal/100 border-2 border-nai-teal/300 rounded-2xl p-12 text-center mb-12 shadow-xl">
                      <h3 className="text-3xl font-bold text-nai-teal/900 mb-8">Master Infection Control with NAI</h3>
                      ...
                      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                        <div className="bg-white rounded-xl p-6 shadow-lg border border-nai-teal/200">
                          ...
                          <h4 className="font-bold text-nai-teal/900 mb-2">Standard Precautions</h4>
                          <p className="text-sm text-gray-600">Universal protection for all patients</p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-lg border border-nai-teal/200">
                          <div className="text-3xl mb-4">🤝</div>
                          <h4 className="font-bold text-nai-teal/900 mb-2">Contact Control</h4>
                          <p className="text-sm text-gray-600">Direct transmission prevention</p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-lg border border-nai-teal/200">
                          <div className="text-3xl mb-4">💨</div>
                          <h4 className="font-bold text-nai-teal/900 mb-2">Droplet Defense</h4>
                          <p className="text-sm text-gray-600">Respiratory infection protection</p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-lg border border-nai-teal/200">
                          <div className="text-3xl mb-4">🌬️</div>
                          <h4 className="font-bold text-nai-teal/900 mb-2">Airborne Safety</h4>
                          <p className="text-sm text-gray-600">Maximum protection protocols</p>
                        </div>
                      </div>
        ...
        <section className="w-full bg-gradient-to-r from-nai-teal via-nai-blue to-nai-teal py-16 sm:py-20 md:py-24">
          <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
            ...
            >
              <Shield className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-white mx-auto mb-6 sm:mb-8" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-4 sm:mb-6 leading-tight">Master Infection Control for NCLEX Success</h2>
              <p className="text-white/95 mb-8 sm:mb-10 text-base sm:text-lg md:text-xl leading-relaxed max-w-3xl mx-auto px-4">
                Build confidence in infection prevention protocols with NAI's comprehensive NCLEX preparation and safety training programs.
              </p>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto px-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  <div className="text-4xl font-bold mb-2">4 Types</div>
                  <div className="text-white/90">Isolation Precautions</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  <div className="text-4xl font-bold mb-2">100%</div>
                  <div className="text-white/90">Patient Safety Focus</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  <div className="text-4xl font-bold mb-2">Expert</div>
                  <div className="text-white/90">Safety Training</div>
                </div>
              </div>
            </motion.div>
          </div>
